        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
          <ul class="nav" id="leftCol" style="margin-top:7% ;">
           ...
           <li>
            ...
            <li>
              <a href="manage-stylists.php"><i class="fa fa-scissors nav_icon"></i>Stylists<span class="fa arrow"></span></a>
              <ul class="nav nav-second-level collapse">
                <li><a href="add-stylist.php">Add Stylist</a></li>
                <li><a href="manage-stylists.php">Manage Stylists</a></li>
              </ul>
            </li>
